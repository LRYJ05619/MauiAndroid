...
@dso_cache = dso_local local_unnamed_addr global [764 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 277694104, ; hash 0x108d4698, from name: Console.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 303253550, ; hash 0x1213482e, from name: Console
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Console.dll.so
		ptr null; void* handle (0x0)
	}, ; 44
	...
	%struct.DSOCacheEntry {
		i64 594318609, ; hash 0x236c9511, from name: libaot-Console
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Console.dll.so
		ptr null; void* handle (0x0)
	}, ; 88
	...
	%struct.DSOCacheEntry {
		i64 1480130122, ; hash 0x5838fe4a, from name: aot-Console.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Console.dll.so
		ptr null; void* handle (0x0)
	}, ; 254
	...
	%struct.DSOCacheEntry {
		i64 1493071467, ; hash 0x58fe766b, from name: aot-Console
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Console.dll.so
		ptr null; void* handle (0x0)
	}, ; 259
	...
	%struct.DSOCacheEntry {
		i64 1608727324, ; hash 0x5fe33b1c, from name: libaot-Console.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Console.dll.so
		ptr null; void* handle (0x0)
	}, ; 270
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [156 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
